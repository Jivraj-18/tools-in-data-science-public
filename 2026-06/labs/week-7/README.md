...
- [Lab: Red-team your own API + add NeMo Guardrails](./red-team-your-api-guardrails)
- [Lab: Full CI/CD: build → scan → Artifact Registry → deploy to Cloud Run](./full-cicd-cloud-run)
