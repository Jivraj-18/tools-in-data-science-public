...
1. [Playwright & Selenium](./playwright-selenium)
2. [Crawl4AI](./crawl4ai)
3. [Firecrawl & Apify](./firecrawl-apify)
4. [Scrapy](./scrapy)
5. [Anti-bot Patterns](./anti-bot-patterns)
6. [Scheduled Scraping](./scheduled-scraping)
7. [Document Parsing](./document-parsing)
8. [DuckDB + Parquet](./duckdb-parquet)
9. [Firestore Database](./firestore)
10. [Vision Models for Scraping](./vision-models-for-scraping)
11. [Image Processing Pipeline](./image-processing-pipeline)
12. [Speech AI — TTS & STT](./speech-ai)
13. [Video Understanding](./video-understanding)
14. [LLM Architecture](./llm-architecture)
